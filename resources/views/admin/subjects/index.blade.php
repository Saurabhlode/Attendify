            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-xl border border-gray-200 dark:border-gray-700">
                <div class="p-8">
                    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 space-y-4 sm:space-y-0">
                        <div>
                            <h3 class="text-2xl font-bold text-gray-900 dark:text-white">Subject Management</h3>
                            <p class="text-gray-600 dark:text-gray-400 mt-1">Create and manage subjects with teacher assignments</p>
                        </div>
                                ...
                                <div class="bg-gradient-to-br from-white to-gray-50 dark:from-gray-700 dark:to-gray-800 rounded-xl border border-gray-200 dark:border-gray-600 p-6 hover:shadow-lg transition-all duration-200">
                                    ...
                                    <div class="space-y-3 mb-6">
                                        <div class="flex items-center text-sm text-gray-600 dark:text-gray-300">
                                            ...
                                            <strong class="mr-2">Teacher:</strong> 
                                        ...
                                        <div class="flex items-center text-sm text-gray-600 dark:text-gray-300">
                                            ...
                                            <strong class="mr-2">Students:</strong> {{ $subject->students->count() }}
                                        </div>
                                    </div>
                                    ...
                                    <div class="border-t border-gray-200 dark:border-gray-600 pt-4">
                                        <div class="flex flex-wrap gap-2">
                                            ...
                                            <a href="{{ route('admin.subjects.enroll', $subject) }}" 
                                               class="inline-flex items-center px-3 py-1 bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-300 rounded-full text-xs font-medium hover:bg-green-200 dark:hover:bg-green-800/50 transition-colors">
                                                <svg class="w-3 h-3 mr-1" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    @else
                        <div class="text-center py-16">
                            ...
                            <h3 class="text-xl font-semibold text-gray-900 dark:text-white mb-2">No Subjects Found</h3>
                            <p class="text-gray-500 dark:text-gray-400 mb-6">Get started by creating your first subject.</p>
                            <a href="{{ route('admin.subjects.create') }}" 
                               class="inline-flex items-center px-6 py-3 bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-lg hover:from-blue-700 hover:to-blue-800 transition-all duration-200 shadow-sm">
                                <svg class="w-4 h-4 mr-2" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M10 3a1 1 0 011 1v5h5a1 1 0 110 2h-5v5a1 1 0 11-2 0v-5H4a1 1 0 110-2h5V4a1 1 0 011-1z" clip-rule="evenodd"/>
                                </svg>
                                Create Subject
