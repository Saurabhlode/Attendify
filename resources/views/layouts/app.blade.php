...
<head>
    ...
    <title>{{ config('app.name', 'Attendify') }} - Smart Attendance Management</title>
...
<body class="font-sans antialiased bg-gray-50 dark:bg-gray-900 transition-colors duration-200">
    <div class="min-h-screen">
        ...
        <main class="pb-8">
            ...
            @if(session('error'))
                <div class="mx-4 mt-4">
                    <div class="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 text-red-800 dark:text-red-200 px-4 py-3 rounded-lg shadow-sm">
                        <div class="flex items-center">
                            <svg class="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 20 20">
